...
trx_cubic_recent <- dbGetQuery(con_dmap, paste0(
  ...
  device_id, fare_prod_desc AS category_name, fare_prod_rider_class_desc AS fare_prod_name, bus_id, operator_name, external_stop_point_id stop_id, latitude lat, longitude lon,
