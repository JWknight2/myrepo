...
---
### AFC1 vs AFC2 Transactions Comparison
---

### Summary of Purpose: 
- This script is used to analyze how many daily transactions are AFC2 
  transactions since its implementation and what proportion of overall 
  transactions that represents per day. These daily totals are compared with 
  AFC1 transactions per day and overall trends are examined over time.
...
- *Data Source 2*: GTFS location data [gtfs_post_recap.stops_2024_2_recap on 
                   Research Server]
- *Data Source 3*: Device ID data for buses [ridership.vehicle_device_ids_bus 
                   on Research Server]
- *Data Source 4*: Device ID data for light rail vehicles [ridership.vehicle
                   _device_ids_lrvs on Research Server]
- *Data Source 5*: Crosswalk data [ridership.crosswalk_sb_cubic on Research 
                   Server]
- *Data Source 6*: Timetable data [afc.tvmtable on Research Server]
- *Data Source 7*: Calendar data [ridership.calendar on Research Server]
- *Data Source 8*: ODX fare transaction table [odx2.fare_transaction on 
                   Research Server]

### Data Outputs:
- *Data Output 1*: Ridership table [ridership.afc_transactions on Research 
                   Server]
- *Data Output 2*: System Validations dashboard [New_AFC2_Dashboards on Tableau 
                   Server]
...
start_date <- ymd(20250220)
end_date <- ymd(20250223)
