...
```{r}
cubic_use_trx <- dbGetQuery(con_dmap, paste0("SELECT external_stop_point_id FROM public.use_transaction_location WHERE (transaction_dtm - interval '3 hours')::date BETWEEN '2025-01-01' AND '2025-01-31'"))
```
